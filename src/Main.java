...
public class Main {
    public static void main(String[] args) {
        ...
        // Inicializar repositorio para empresas
        ...
        // Agregemos algunos articulos a sucursales
        sucursal1.agregarArticulo(sal, "sals1");
        sucursal2.agregarArticulo(harina, "hars2");
        sucursal2.agregarArticulo(sal, "sals2");
        sucursal2.agregarArticulo(aceite, "aces2");
        sucursal3.agregarArticulo(harina, "hars3");
        sucursal4.agregarArticulo(sal, "sals4");
        ...
        // Mostrar los articulos de una sucursal
        System.out.println("--------------Mostrar los articulos de cada sucursal de una empresa determinada--------------");
        Optional<Empresa> empresaEjemplo = empresaRepository.findById(1L);
        if (empresa.isPresent()) {
            System.out.println("Sucursales de la empresa con ID " + empresa.get().getId() + ":");
            Set<Sucursal> sucursales = empresa.get().getSucursales();
            for (Sucursal sucursal : sucursales) {
                System.out.println("Articulos de la sucursal numero con ID " + sucursal.getId() + ":");
                for (SucursalArticulo sucursalArticulo : sucursal.getListaSucursalArticulo()) {
                    System.out.println("   -" + sucursalArticulo.getArticulo().getDenominacion());
                }
            }
        } else {
            System.out.println("Empresa con ID " + " no encontrada.");
